...
if __name__ == '__main__':
    ...
    print(config.get_verbosity_level(level='critical', text=False))
    print(config.get_verbosity_level(level='error', text=False))
    print(config.get_verbosity_level(level='warning', text=False))
    print(config.get_verbosity_level(level='info', text=False))
